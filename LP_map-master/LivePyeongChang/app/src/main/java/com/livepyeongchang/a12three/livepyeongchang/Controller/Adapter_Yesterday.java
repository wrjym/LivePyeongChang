...
public class Adapter_Yesterday extends RecyclerView.Adapter<Adapter_Yesterday.ViewHolder>{

    List<Model_Main> tempArr;
    Context context;

    public Adapter_Yesterday(List<Model_Main> tempArr, Context context){
    ...
    @Override
    public void onBindViewHolder(Adapter_Yesterday.ViewHolder holder, final int position) {
        ...
        if(tempArr.get(position).getDate().equals(timeManager.addDate(-1, true))) {
            ...
            holder.ll_frame.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ad.setIcon(R.drawable.icon_result);
                    String negative = "Go to page";
                    String title = "Match Highlight & Result";
